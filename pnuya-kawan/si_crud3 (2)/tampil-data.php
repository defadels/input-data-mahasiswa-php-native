        ...
        <div class="panel-body">
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              if (isset($cari)) {
                $jumlah_record = mysqli_query($db, "SELECT * FROM tbl_siswa
              ...
              while ($data = mysqli_fetch_assoc($query)) {
                ...
                echo "  <tr>
                      ...
                      <td width='10'>$data[kode_siswa]</td>
                      <td width='100'>$data[nama_siswa]</td>
                      <td width='180'>$data[tempat_lahir], $tanggal_lahir</td>
                      <td width='100'>$data[jenis_kelamin]</td>
                      <td width='80'>$data[agama]</td>
                      <td width='120'>$data[alamat]</td>
                      <td width='80'>$data[no_hpwali]</td>
                      <td width='60'>$data[nama_wali]</td>
                      <td width='60'>$data[usia]</td>
